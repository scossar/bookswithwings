	...
	<fieldset>
		<div class="form-group">
			...
			<div class="field account-sign-in">
				...
				<a class="button btn" href="<?php echo apply_filters( 'submit_donation_form_logout_url',
					wp_logout_url( get_permalink() ) ); ?>"><?php _e( 'Sign out', 'wpdonations' ); ?></a>
			</div>
		</div>
	</fieldset>
...
<?php else :
	...
	<fieldset>
		<div class="form-group">
			...
			<div class="field account-sign-in">
				<a class="button btn" href="<?php echo apply_filters( 'submit_donation_form_login_url', wp_login_url( get_permalink() ) ); ?>"><?php _e( 'Sign in', 'wpdonations' ); ?></a>
	...
	<?php if ( $registration_enabled ) : ?>
		<fieldset>
			<div class="form-group">
				...
				<div class="field">
					<input type="email" class="input-text form-control" name="create_account_email" id="account_email" placeholder="<?php _e( 'you@yourdomain.com', 'wpdonations' ); ?>" value="<?php if ( ! empty( $_POST['create_account_email'] ) ) echo sanitize_text_field( stripslashes( $_POST['create_account_email'] ) ); ?>" />
				</div>
			</div>
		</fieldset>
	<?php endif; ?>
